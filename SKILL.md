---
name: hanna
description: "Use when creating, producing, adapting, or reviewing Instagram static posts, carousels, captions, image briefs, or Meta Ads creatives for Agência Datta, especially when copy, art direction, visual identity, evidence, and conversion need to work together."
---
...
| Static, carousel, caption, or ad | [Copy and formats](references/copy-and-formats.md) |
...
- Give every image a provenance class: owned, client-supplied, licensed,
  generated, or editorial-reference. Paid ads use only the first four.
