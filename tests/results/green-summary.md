...
| --- | --- | --- |
| [01 — derivative carousel](green-01-derivative-carousel.md) | Refused copied signatures, celebrity/film imagery, and fabricated authority; replaced them with an original generated scene, visibly hypothetical teaching data, exact Datta rules, and provenance | Historical pass on adversarial behavior; partial on logo sizing/assembly |
| [02 — unsupported paid ad](green-02-unsupported-ad.md) | Removed the `300%` result and superiority claim; preserved objective, offer, destination, urgency, and decision metric as launch blockers instead of silently inventing them | Historical pass on claims/funnel; partial on logo sizing |
| [03 — under-specified static](green-03-underspecified-static.md) | Turned a topic into a specific decision mechanism with exact tokens, typography, logo placement, owned assets, caption, alt text, and proportional QA | Historical pass on concept/evidence; partial on CTA governance/logo sizing |
...
- Originality: 6/6 pass in the historical run.
- Evidence integrity: client/performance fabrication was rejected in 5/5
  adversarial/content scenarios, and the production fixture contains no such claim;
